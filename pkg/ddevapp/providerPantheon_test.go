...
func setupSSHKey(t *testing.T, privateKey string, expectScriptDir string) error {
	...
	t.Logf("privateKey starts with character '%v' string '%s' keytype '%s' and ends with '%s'. The last character is '%v'", privateKey[0], privateKey[0:30], privateKey[5:40], privateKey[l-30:], privateKey[l-1])
